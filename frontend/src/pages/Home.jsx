          ...
          <div className="mt-16 pt-16 border-t border-gray-100">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                ...
                <p className="text-gray-600">{t('home.stats.accuracy', 'Accuracy Rate')}</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-teal-600 mb-2">3s</div>
                <p className="text-gray-600">{t('home.stats.time', 'Average Processing Time')}</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-teal-600 mb-2">100K+</div>
                <p className="text-gray-600">{t('home.stats.images', 'Daily Processed Images')}</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-teal-600 mb-2">16</div>
                <p className="text-gray-600">{t('home.stats.languages', 'Supported Languages')}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mt-20 bg-white p-6 rounded-xl shadow-md max-w-2xl mx-auto border border-teal-100">
            <div className="flex items-start">
              ...
              <div>
                <p className="text-gray-600 italic mb-4">{t('home.testimonial.quote', '"iMagenWiz has revolutionized our product photography workflow. What used to take hours now takes seconds, and the results are flawless!"')}</p>
                <p className="text-sm font-medium text-gray-900">{t('home.testimonial.author', 'Sarah Johnson, E-commerce Manager')}</p>
              </div>
            </div>
          </div>
        </div>
